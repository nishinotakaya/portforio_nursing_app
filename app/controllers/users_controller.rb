class UsersController < ApplicationController
  ...
  def show
    ...
    @edit_one_month_count = Attendance.where(started_at: (1.days.ago)..(Time.now), finished_at: (1.days.ago)..(Time.now), instructor_confirmation: @user.name).count #勤怠変更更新のお知らせ件数
  end
