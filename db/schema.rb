...
ActiveRecord::Schema.define(version: 20200803102609) do
  ...
  create_table "clients", force: :cascade do |t|
    ...
    t.string "monitoring_walking_yes_self_support"
    t.string "monitoring_walking_so_yes_self_support"
    t.string "monitoring_walking_so_no_self_support"
    t.string "monitoring_walking_no_self_support"
    t.string "monitoring_walking_no_self_support_car_chaice"
  ...
  create_table "staffs", force: :cascade do |t|
    ...
    t.string "uid"
    t.datetime "designated_work_start_time", default: "2020-08-03 22:00:00"
    t.datetime "designated_work_end_time", default: "2020-08-04 09:00:00"
    t.string "staff_id"
    t.datetime "basic_work_time", default: "2020-08-03 21:30:00"
